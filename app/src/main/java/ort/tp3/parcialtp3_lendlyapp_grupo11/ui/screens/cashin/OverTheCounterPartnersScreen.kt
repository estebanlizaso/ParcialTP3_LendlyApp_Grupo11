...
fun OverTheCounterPartnersScreen(
    ...
    val partners = listOf(
        CashInPartner("7-Eleven", "7", Color(0xFF00A859)),
        CashInPartner("Cebuana Lhuillier", "C", Color(0xFF073F59)),
        CashInPartner("LBC", "LBC", Color(0xFFE91E4D)),
        CashInPartner("M Lhuillier", "ML", Color(0xFFFF1F1F))
    )
