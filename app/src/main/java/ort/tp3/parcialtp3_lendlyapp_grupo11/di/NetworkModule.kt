...
import ort.tp3.parcialtp3_lendlyapp_grupo11.network.AuthInterceptor
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideLendlyApi(retrofit: Retrofit): LendlyApi {
        return retrofit.create(LendlyApi::class.java)
    }
}
